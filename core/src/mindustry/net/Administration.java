...
public class Administration{
    ...
    public static class Config{
        ...
        yzfSyncReliability = new Config("yzfSyncReliability", "YZF client snapshot reliability mode: adaptive, always or off.", "adaptive"),
        yzfNoPlayerHitBox = new Config("yzfNoPlayerHitBox", "Whether clients skip local player physics pushback to reduce rubberbanding.", true),
        yzfCorrectionReliableMs = new Config("yzfCorrectionReliableMs", "How long client snapshots are sent reliably after a server correction, in ms.", 1500),
        yzfRubberbandDistance = new Config("yzfRubberbandDistance", "Position correction distance counted as a rubberband.", 80),
        yzfNoUpdatePlayerMovement = new Config("yzfNoUpdatePlayerMovement", "Debug switch that disables local player movement updates.", false),
